...
const About = () => {
  return (
    <div className={`${styles.aboutContainer} container`}>
      <h1 className={`${styles.heading} heading`}>About</h1>
      <div className={styles.separator}></div>
      
      <div className={styles.contentColumns}>
        <div className={`${styles.mainContent} card`}>
          <p>
        ...
        <div className={styles.sidebar}>
          <div className={`${styles.quoteBox} card`}>
            <span className="icon"><AboutIcons.Quote /></span>
            <blockquote>"Life's most persistent and urgent question is, 'What are you doing for others?'"</blockquote>
            <cite>- Martin Luther King Jr.</cite>
          </div>
          
          <div className={`${styles.impactStats} card`}>
            <div className="cardHeader">
              <span className="icon"><AboutIcons.Impact /></span>
              <h3 className="cardTitle">Our Impact</h3>
            </div>
            <ul>
              <li>10,000+ Donors</li>
              <li>$1M+ Raised</li>
      ...
      <div className={`${styles.highlightBox} card`}>
        <span className="icon"><AboutIcons.Highlight /></span>
        <p>
      ...
      <Link to="/signup" className={`${styles.ctaButton} button`}>
        <span className="icon"><AboutIcons.Join /></span>
        Join Us Today
      </Link>
    </div>
  );
